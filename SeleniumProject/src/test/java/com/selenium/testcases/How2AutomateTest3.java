 ...
 *
 */
public class How2AutomateTest3 extends BaseClass {
	...
	@Test(groups = "Smoke")
	public void checkFacebookLinkAgain() {
		
		Log.startTest("checkFacebookLinkAgain");
		
		mainPage = new MainPage();
		Log.info("Check facebook link");
		Assert.assertTrue(mainPage.checkFacebookLink());
		
		Log.endTest("checkFacebookLinkAgain");
